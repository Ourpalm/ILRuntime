...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Collections_Generic_List_1_String_Binding_Enumerator_Binding
    {
        ...
        static StackObject* get_Current_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.List<System.String>.Enumerator instance_of_this_method = new System.Collections.Generic.List<System.String>.Enumerator();
            __clrType = (CLRType)__domain.GetType (typeof(System.Collections.Generic.List<System.String>.Enumerator));
            __binder = __clrType.ValueTypeBinder;
            if (__binder != null) {
                instance_of_this_method = ((ValueTypeBinder<System.Collections.Generic.List<System.String>.Enumerator>)__binder).ParseValue (__intp, ptr_of_this_method, __mStack);
            } else {
                ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            ...
            __binder = __clrType.ValueTypeBinder;
            if (__binder != null) {
                ((ValueTypeBinder<System.Collections.Generic.List<System.String>.Enumerator>)__binder).WriteBackValue(__domain, ptr_of_this_method, __mStack, ref instance_of_this_method);
            } else {
