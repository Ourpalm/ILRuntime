...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ILRuntimeTest_TestFramework_IntDelegate_Binding
    {
        ...
        static StackObject* Invoke_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntimeTest.TestFramework.IntDelegate instance_of_this_method;
            instance_of_this_method = (ILRuntimeTest.TestFramework.IntDelegate)typeof(ILRuntimeTest.TestFramework.IntDelegate).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
