...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Collections_Generic_Dictionary_2_Int32_Int32_Binding
    {
        ...
        static StackObject* GetEnumerator_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if (__binder != null) {
                ((ValueTypeBinder<System.Collections.Generic.Dictionary<System.Int32, System.Int32>.Enumerator>)__binder).PushValue(ref result_of_this_method, __intp, __ret, __mStack);
                return __ret + 1;
            } else {
