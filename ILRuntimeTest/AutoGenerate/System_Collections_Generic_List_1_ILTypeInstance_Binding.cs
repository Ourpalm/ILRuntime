...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Collections_Generic_List_1_ILTypeInstance_Binding
    {
        ...
        static StackObject* GetEnumerator_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if (__binder != null) {
                ((ValueTypeBinder<System.Collections.Generic.List<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Enumerator>)__binder).PushValue(ref result_of_this_method, __intp, __ret, __mStack);
                return __ret + 1;
            } else {
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
            }
