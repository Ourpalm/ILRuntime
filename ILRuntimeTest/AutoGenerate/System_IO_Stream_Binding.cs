...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_IO_Stream_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, WriteByte_0);
            args = new Type[]{};
        ...
        static StackObject* WriteByte_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
