...
最新2.0版本的ILRuntime，在10多项测试用例当中的性能，均已超过lua53版xlua，详细测试代码可参见ILRuntime的[U3D Demo工程](https://github.com/Ourpalm/ILRuntimeU3D/)