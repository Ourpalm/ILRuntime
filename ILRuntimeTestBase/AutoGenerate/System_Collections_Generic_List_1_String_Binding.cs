...
namespace ILRuntime.Runtime.Generated
{
    ...
    unsafe class System_Collections_Generic_List_1_String_Binding
    {
        ...
        static void Add_0_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ...
            int __curPrim = 0;
            System.Collections.Generic.List<System.String> instance_of_this_method = (System.Collections.Generic.List<System.String>)ILIntepreter.ReadNeoReference(__frameBase, ref __curPrim, __mStack);
            System.String @item = (System.String)ILIntepreter.ReadNeoReference(__frameBase, ref __curPrim, __mStack);
        ...
        static StackObject* Add_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.String @item = (System.String)typeof(System.String).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (ILRuntime.CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = __esp - 2;
            System.Collections.Generic.List<System.String> instance_of_this_method = (System.Collections.Generic.List<System.String>)typeof(System.Collections.Generic.List<System.String>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (ILRuntime.CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static void Ctor_0_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ...
            System.Collections.Generic.List<System.String> result_of_this_method = new System.Collections.Generic.List<System.String>();
            if (__retDst != null)
            {
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if(!isNewObj) 
            {
                ...
                System.Collections.Generic.List<System.String> __this = (System.Collections.Generic.List<System.String>)typeof(System.Collections.Generic.List<System.String>).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
                __intp.Free(ptr_of_this_method);
