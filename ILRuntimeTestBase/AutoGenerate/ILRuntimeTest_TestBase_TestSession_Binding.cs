...
namespace ILRuntime.Runtime.Generated
{
    ...
    unsafe class ILRuntimeTest_TestBase_TestSession_Binding
    {
...
#if ENABLE_NEO_MODE
            app.RegisterCLRMethodRedirectionNeo(method, get_LastSession_0_Neo);
#else
...
#if ENABLE_NEO_MODE
            app.RegisterCLRMethodRedirectionNeo(method, get_Appdomain_1_Neo);
#else
...
#if ENABLE_NEO_MODE
        static void get_LastSession_0_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
...
#if ENABLE_NEO_MODE
        static void get_Appdomain_1_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            int __curPrim = 0;
            ILRuntimeTest.TestBase.TestSession instance_of_this_method = (ILRuntimeTest.TestBase.TestSession)ILIntepreter.ReadNeoReference(__frameBase, ref __curPrim, __mStack);
        ...
        static StackObject* get_Appdomain_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntimeTest.TestBase.TestSession instance_of_this_method = (ILRuntimeTest.TestBase.TestSession)typeof(ILRuntimeTest.TestBase.TestSession).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (ILRuntime.CLR.Utils.Extensions.TypeFlags)0);
