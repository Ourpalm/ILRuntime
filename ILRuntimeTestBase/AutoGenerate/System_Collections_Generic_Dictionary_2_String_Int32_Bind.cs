...
namespace ILRuntime.Runtime.Generated
{
    ...
    unsafe class System_Collections_Generic_Dictionary_2_String_Int32_Binding
    {
...
#if ENABLE_NEO_MODE
            app.RegisterCLRMethodRedirectionNeo(method, get_Item_2_Neo);
#else
...
#if ENABLE_NEO_MODE
            app.RegisterCLRMethodRedirectionNeo(method, Add_3_Neo);
#else
        ...
        static void set_Item_0_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ...
            int __curPrim = 0;
            System.Collections.Generic.Dictionary<System.String, System.Int32> instance_of_this_method = (System.Collections.Generic.Dictionary<System.String, System.Int32>)ILIntepreter.ReadNeoReference(__frameBase, ref __curPrim, __mStack);
        ...
        static StackObject* set_Item_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.Dictionary<System.String, System.Int32> instance_of_this_method = (System.Collections.Generic.Dictionary<System.String, System.Int32>)typeof(System.Collections.Generic.Dictionary<System.String, System.Int32>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (ILRuntime.CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
...
#if ENABLE_NEO_MODE
        static void get_Item_2_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            int __curPrim = 0;
            System.Collections.Generic.Dictionary<System.String, System.Int32> instance_of_this_method = (System.Collections.Generic.Dictionary<System.String, System.Int32>)ILIntepreter.ReadNeoReference(__frameBase, ref __curPrim, __mStack);
...
#if ENABLE_NEO_MODE
        static void Add_3_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            int __curPrim = 0;
            System.Collections.Generic.Dictionary<System.String, System.Int32> instance_of_this_method = (System.Collections.Generic.Dictionary<System.String, System.Int32>)ILIntepreter.ReadNeoReference(__frameBase, ref __curPrim, __mStack);
        ...
        static void Ctor_0_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ...
            System.Collections.Generic.Dictionary<System.String, System.Int32> result_of_this_method = new System.Collections.Generic.Dictionary<System.String, System.Int32>();
            if (__retDst != null)
            {
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if(!isNewObj) 
            {
                ...
                System.Collections.Generic.Dictionary<System.String, System.Int32> __this = (System.Collections.Generic.Dictionary<System.String, System.Int32>)typeof(System.Collections.Generic.Dictionary<System.String, System.Int32>).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
                __intp.Free(ptr_of_this_method);
