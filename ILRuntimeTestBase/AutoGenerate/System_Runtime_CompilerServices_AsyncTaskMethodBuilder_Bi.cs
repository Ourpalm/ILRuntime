...
namespace ILRuntime.Runtime.Generated
{
    ...
    unsafe class System_Runtime_CompilerServices_AsyncTaskMethodBuilder_Binding
    {
            ...
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(System.Runtime.CompilerServices.TaskAwaiter).MakeByRefType(), typeof(ILRuntimeTest.TestFramework.IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
#if ENABLE_NEO_MODE
                        app.RegisterCLRMethodRedirectionNeo(method, AwaitUnsafeOnCompleted_3_Neo);
#else
...
#if ENABLE_NEO_MODE
            app.RegisterCLRMethodRedirectionNeo(method, SetException_4_Neo);
#else
...
#if ENABLE_NEO_MODE
            app.RegisterCLRMethodRedirectionNeo(method, SetResult_5_Neo);
#else
        ...
        static void Start_1_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            int __curPrim = 0;
            System.Runtime.CompilerServices.AsyncTaskMethodBuilder instance_of_this_method = default(System.Runtime.CompilerServices.AsyncTaskMethodBuilder);
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            object instance_of_this_method = (System.Runtime.CompilerServices.AsyncTaskMethodBuilder)typeof(System.Runtime.CompilerServices.AsyncTaskMethodBuilder).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (ILRuntime.CLR.Utils.Extensions.TypeFlags)16);

            ((System.Runtime.CompilerServices.AsyncTaskMethodBuilder)instance_of_this_method).Start<ILRuntimeTest.TestFramework.IAsyncStateMachineClassInheritanceAdaptor.IAsyncStateMachineAdaptor>(ref @stateMachine);
        ...
        static StackObject* get_Task_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = __esp - 1;
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            System.Runtime.CompilerServices.AsyncTaskMethodBuilder instance_of_this_method = (System.Runtime.CompilerServices.AsyncTaskMethodBuilder)typeof(System.Runtime.CompilerServices.AsyncTaskMethodBuilder).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (ILRuntime.CLR.Utils.Extensions.TypeFlags)16);
...
#if ENABLE_NEO_MODE
        static void AwaitUnsafeOnCompleted_3_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            int __curPrim = 0;
            System.Runtime.CompilerServices.AsyncTaskMethodBuilder instance_of_this_method = default(System.Runtime.CompilerServices.AsyncTaskMethodBuilder);
...
#if ENABLE_NEO_MODE
        static void SetException_4_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            int __curPrim = 0;
            System.Runtime.CompilerServices.AsyncTaskMethodBuilder instance_of_this_method = default(System.Runtime.CompilerServices.AsyncTaskMethodBuilder);
...
#if ENABLE_NEO_MODE
        static void SetResult_5_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            int __curPrim = 0;
            System.Runtime.CompilerServices.AsyncTaskMethodBuilder instance_of_this_method = default(System.Runtime.CompilerServices.AsyncTaskMethodBuilder);
