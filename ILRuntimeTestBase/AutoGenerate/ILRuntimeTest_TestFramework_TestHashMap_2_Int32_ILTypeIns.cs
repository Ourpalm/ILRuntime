...
namespace ILRuntime.Runtime.Generated
{
    ...
    unsafe class ILRuntimeTest_TestFramework_TestHashMap_2_Int32_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILRuntimeTest.TestFramework.TestHashMap<System.Int32, ILRuntime.Runtime.Intepreter.ILTypeInstance>);
        ...
        static void Add_0_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ...
            int __curPrim = 0;
            ILRuntimeTest.TestFramework.TestHashMap<System.Int32, ILRuntime.Runtime.Intepreter.ILTypeInstance> instance_of_this_method = (ILRuntimeTest.TestFramework.TestHashMap<System.Int32, ILRuntime.Runtime.Intepreter.ILTypeInstance>)ILIntepreter.ReadNeoReference(__frameBase, ref __curPrim, __mStack);
        ...
        static StackObject* Add_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntimeTest.TestFramework.TestHashMap<System.Int32, ILRuntime.Runtime.Intepreter.ILTypeInstance> instance_of_this_method = (ILRuntimeTest.TestFramework.TestHashMap<System.Int32, ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(ILRuntimeTest.TestFramework.TestHashMap<System.Int32, ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (ILRuntime.CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static void Ctor_0_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ...
            ILRuntimeTest.TestFramework.TestHashMap<System.Int32, ILRuntime.Runtime.Intepreter.ILTypeInstance> result_of_this_method = new ILRuntimeTest.TestFramework.TestHashMap<System.Int32, ILRuntime.Runtime.Intepreter.ILTypeInstance>();
            if (__retDst != null)
            {
                if (__retRefBase >= __mStack.Count)
                    __mStack.Add(result_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if(!isNewObj) 
            {
                ...
                ILRuntimeTest.TestFramework.TestHashMap<System.Int32, ILRuntime.Runtime.Intepreter.ILTypeInstance> __this = (ILRuntimeTest.TestFramework.TestHashMap<System.Int32, ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(ILRuntimeTest.TestFramework.TestHashMap<System.Int32, ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
                __intp.Free(ptr_of_this_method);
                if(__this is CrossBindingAdaptorType)
                    return __esp - 1;
            }
            var result_of_this_method = new ILRuntimeTest.TestFramework.TestHashMap<System.Int32, ILRuntime.Runtime.Intepreter.ILTypeInstance>();
