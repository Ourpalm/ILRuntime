...
namespace ILRuntime.Runtime.Generated
{
    ...
    unsafe class System_Collections_Generic_List_1_TestVector3NoBinding_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<ILRuntimeTest.TestFramework.TestVector3NoBinding>);
            args = new Type[]{typeof(ILRuntimeTest.TestFramework.TestVector3NoBinding)};
        ...
        static StackObject* Add_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntimeTest.TestFramework.TestVector3NoBinding @item = (ILRuntimeTest.TestFramework.TestVector3NoBinding)typeof(ILRuntimeTest.TestFramework.TestVector3NoBinding).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (ILRuntime.CLR.Utils.Extensions.TypeFlags)16);
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = __esp - 2;
            System.Collections.Generic.List<ILRuntimeTest.TestFramework.TestVector3NoBinding> instance_of_this_method = (System.Collections.Generic.List<ILRuntimeTest.TestFramework.TestVector3NoBinding>)typeof(System.Collections.Generic.List<ILRuntimeTest.TestFramework.TestVector3NoBinding>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (ILRuntime.CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static void Ctor_0_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ...
            System.Collections.Generic.List<ILRuntimeTest.TestFramework.TestVector3NoBinding> result_of_this_method = new System.Collections.Generic.List<ILRuntimeTest.TestFramework.TestVector3NoBinding>();
            if (__retDst != null)
            {
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if(!isNewObj) 
            {
                ...
                System.Collections.Generic.List<ILRuntimeTest.TestFramework.TestVector3NoBinding> __this = (System.Collections.Generic.List<ILRuntimeTest.TestFramework.TestVector3NoBinding>)typeof(System.Collections.Generic.List<ILRuntimeTest.TestFramework.TestVector3NoBinding>).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
                __intp.Free(ptr_of_this_method);
                if(__this is CrossBindingAdaptorType)
                    return __esp - 1;
            }
            var result_of_this_method = new System.Collections.Generic.List<ILRuntimeTest.TestFramework.TestVector3NoBinding>();
