...
namespace ILRuntime.Runtime.Generated
{
    ...
    unsafe class ILRuntimeTest_TestBase_SubExtensionClass_1_Int32_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILRuntimeTest.TestBase.SubExtensionClass<System.Int32>);
        ...
        static void Ctor_0_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ...
            ILRuntimeTest.TestBase.SubExtensionClass<System.Int32> result_of_this_method = new ILRuntimeTest.TestBase.SubExtensionClass<System.Int32>();
            if (__retDst != null)
            {
