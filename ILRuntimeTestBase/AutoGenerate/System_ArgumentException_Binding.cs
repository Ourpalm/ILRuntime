...
namespace ILRuntime.Runtime.Generated
{
    ...
    unsafe class System_ArgumentException_Binding
    {
        ...
        static void Ctor_0_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ...
            System.ArgumentException result_of_this_method = new System.ArgumentException();
            if (__retDst != null)
            {
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if(!isNewObj) 
            {
                ...
                System.ArgumentException __this = (System.ArgumentException)typeof(System.ArgumentException).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
