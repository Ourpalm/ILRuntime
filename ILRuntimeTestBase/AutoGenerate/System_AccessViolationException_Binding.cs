    ...
    unsafe class System_AccessViolationException_Binding
    {
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if(!isNewObj) 
            {
                ...
                System.AccessViolationException __this = (System.AccessViolationException)typeof(System.AccessViolationException).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
