...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ILRuntimeTest_TestFramework_TestVector3NoBinding_Binding
    {
        ...
        static StackObject* op_Multiply_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntimeTest.TestFramework.TestVector3NoBinding @a = (ILRuntimeTest.TestFramework.TestVector3NoBinding)typeof(ILRuntimeTest.TestFramework.TestVector3NoBinding).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
        ...
        static StackObject* op_Addition_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ILRuntimeTest.TestFramework.TestVector3NoBinding @b = (ILRuntimeTest.TestFramework.TestVector3NoBinding)typeof(ILRuntimeTest.TestFramework.TestVector3NoBinding).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
            __intp.Free(ptr_of_this_method);
