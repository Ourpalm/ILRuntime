...
namespace ILRuntime.Runtime.Generated
{
    ...
    unsafe class ILRuntimeTest_TestFramework_TestVectorStruct2_Binding
    {
        ...
        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref ILRuntimeTest.TestFramework.TestVectorStruct2 instance_of_this_method)
        {
        ...
        {
            return ((ILRuntimeTest.TestFramework.TestVectorStruct2)o).Vector;
        }

        static StackObject* CopyToStack_Vector_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((ILRuntimeTest.TestFramework.TestVectorStruct2)o).Vector;
