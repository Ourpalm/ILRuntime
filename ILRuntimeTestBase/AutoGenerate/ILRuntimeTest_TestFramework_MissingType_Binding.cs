...
namespace ILRuntime.Runtime.Generated
{
    ...
    unsafe class ILRuntimeTest_TestFramework_MissingType_Binding
    {
        ...
        static void Ctor_0_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ...
            ILRuntimeTest.TestFramework.MissingType result_of_this_method = new ILRuntimeTest.TestFramework.MissingType();
            if (__retDst != null)
            {
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if(!isNewObj) 
            {
                ...
                ILRuntimeTest.TestFramework.MissingType __this = (ILRuntimeTest.TestFramework.MissingType)typeof(ILRuntimeTest.TestFramework.MissingType).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
