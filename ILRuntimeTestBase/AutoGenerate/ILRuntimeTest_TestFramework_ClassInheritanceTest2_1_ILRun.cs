...
#if ENABLE_NEO_MODE
            app.RegisterCLRMethodRedirectionNeo(method, TestVirtual_0_Neo);
#else
...
#if ENABLE_NEO_MODE
        static void TestVirtual_0_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            int __curPrim = 0;
            ILRuntimeTest.TestFramework.ClassInheritanceTest2<ILRuntimeTest.TestFramework.ClassInheritanceTest2Adaptor.Adaptor> instance_of_this_method = (ILRuntimeTest.TestFramework.ClassInheritanceTest2<ILRuntimeTest.TestFramework.ClassInheritanceTest2Adaptor.Adaptor>)ILIntepreter.ReadNeoReference(__frameBase, ref __curPrim, __mStack);
