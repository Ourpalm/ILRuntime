    ...
    unsafe class ILRuntimeTest_TestFramework_DelegateTest_Binding
    {
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            if(!isNewObj) 
            {
                ...
                ILRuntimeTest.TestFramework.DelegateTest __this = (ILRuntimeTest.TestFramework.DelegateTest)typeof(ILRuntimeTest.TestFramework.DelegateTest).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
                __intp.Free(ptr_of_this_method);
