...
namespace ILRuntime.Runtime.Intepreter.RegisterVM
{
    struct JITCompiler
    {
        ...
        public OpCodes.OpCodeR[] Compile()
        {
            var body = def.Body;
            ...
            List<OpCodes.OpCodeR> lst = new List<OpCodes.OpCodeR>();
        ...
        void Translate(List<OpCodes.OpCodeR> lst, Instruction ins, short locVarRegStart, ref short baseRegIdx)
        {
            OpCodes.OpCodeR op = new OpCodes.OpCodeR();
            var code = ins.OpCode;
            var token = ins.Operand;
            op.Code = (OpCodes.OpCodeREnum)code.Code;
            bool hasRet;
            switch (code.Code)
            {
                case Code.Br_S:
